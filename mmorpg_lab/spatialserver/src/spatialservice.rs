...
const MAX_ENTITIES_PER_SHARD: usize = 10; // For testing purposes, we keep it low to trigger splits more easily. In production, this should be much higher and/or adaptive based on server performance metrics.
